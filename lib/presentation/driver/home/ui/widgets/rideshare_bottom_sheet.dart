      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            DriverRideshareShowcase.buildPickupInfoShowcase(
              child: PickupInfoWidget(
            ...
            DriverRideshareShowcase.buildPassengerInfoShowcase(
              child: PassengerInfoWidget(
            ...
            const SizedBox(height: 16),
            DriverRideshareShowcase.buildMessageCallShowcase(
              child: Row(
                children: [
                  Expanded(
                    flex: 5,
            ...
            const SizedBox(height: 16),
            DriverRideshareShowcase.buildTripStoppageShowcase(
              child: TripStoppageInfoWidget(
                stoppageLocation: uiState.rideRequest!.dropoffAddress,
              ),
            ),
            uiState.isRideStart
                ? DriverRideshareShowcase.buildActionButtonShowcase(
                  child: Padding(
