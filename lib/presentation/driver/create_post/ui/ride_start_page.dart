import 'package:cabwire/presentation/driver/create_post/widgets/ride_bottom_sheet.dart';
import 'package:cabwire/presentation/driver/home/widgets/top_navigation_bar.dart';
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            Positioned(bottom: 0, left: 0, right: 0, child: RideBottomSheet()),
          ],
        ),
      ),
    );
