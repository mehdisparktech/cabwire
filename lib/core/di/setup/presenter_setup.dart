...
class PresenterSetup implements SetupModule {
  ...
  Future<void> setup() async {
    _serviceLocator
      ...
      ..registerLazySingleton(
        () => loadPresenter(
          DriverProfilePresenter(locate(), locate(), locate(), locate()),
        ),
      )
      ..registerLazySingleton(
        () => loadPresenter(
      ...
      ..registerLazySingleton(
        () => loadPresenter(EarningsPresenter(locate(), locate())),
      )
      ..registerLazySingleton(
      ...
      ..registerLazySingleton(
        () => loadPresenter(RideSharePresenter(submitReviewUseCase: locate())),
      )
      ..registerLazySingleton(
